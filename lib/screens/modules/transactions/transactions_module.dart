      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Icon(
              NavigationItem.transactions.icon,
              size: 60,
              color: NavigationItem.transactions.color,
            ),
          ),
          ...
          Text(
            NavigationItem.transactions.description,
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: NavigationItem.transactions.color.withOpacity(0.1),
              borderRadius: BorderRadius.circular(AdminTheme.radiusMd),
              border: Border.all(
                color: NavigationItem.transactions.color.withOpacity(0.3),
              ),
            ),
            child: Text(
              'Coming Soon',
