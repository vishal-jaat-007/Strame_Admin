      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child: Icon(
              NavigationItem.withdrawals.icon,
              size: 60,
              color: NavigationItem.withdrawals.color,
            ),
          ),
          ...
          Text(
            NavigationItem.withdrawals.title,
          ...
          Text(
            NavigationItem.withdrawals.description,
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: NavigationItem.withdrawals.color.withOpacity(0.1),
              borderRadius: BorderRadius.circular(AdminTheme.radiusMd),
              border: Border.all(
                color: NavigationItem.withdrawals.color.withOpacity(0.3),
              ),
            ),
            child: Text(
              'Coming Soon',
